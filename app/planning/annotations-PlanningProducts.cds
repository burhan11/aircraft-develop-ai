...
annotate service.PlanningProducts with {
...
annotate service.ProductsWithoutExpands with {
...
annotate service.ProductsWithoutExpands {
...
annotate service.PlanningProducts with {
    sizeKey          @(Common.ValueList: {
        $Type         : 'Common.ValueListType',
        CollectionPath: 'SAC_SIZE_KEYS',
        SearchSupported,
        Parameters    : [
            {
                $Type            : 'Common.ValueListParameterInOut',
                LocalDataProperty: 'sizeKey',
                ValueListProperty: 'sizeKey'
            },
            {
    ...
    differingSizeKey @(Common.ValueList: {
        $Type         : 'Common.ValueListType',
        CollectionPath: 'SAC_SIZE_KEYS',
        SearchSupported,
        Parameters    : [
            {
                $Type            : 'Common.ValueListParameterInOut',
                LocalDataProperty: 'differingSizeKey',
                ValueListProperty: 'sizeKey'
            },
            {
                $Type            : 'Common.ValueListParameterIn',
...
annotate service.PlanningProducts {
    product               @Common.Label: '{i18n>ProductID}';
...
annotate service.PlanningProducts with @(
    ...
    UI.SelectionFields: [
        product.evaluationColor_ID,
        product.seasonType_ID,
    ...
    supplyType      @(
        Common.ValueList: {
            ...
            Parameters    : [
                {
                    $Type            : 'Common.ValueListParameterIn',
                    LocalDataProperty: product_supplyType_SUPPLY_TYPE,
