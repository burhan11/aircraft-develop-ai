...
annotate service.ProductSizes with {
    supplier              @(
        Common.ValueList: {
    ...
    product               @(
        Common.ValueList: {
            ...
            Parameters    : [
                ...
                {
                    $Type            : 'Common.ValueListParameterDisplayOnly',
                    ValueListProperty: 'evaluationColorName',
                },
            ]
        },
        Common.Text     : {
    ...
    supplierProductNumber @(Common.ValueList: {
        $Type         : 'Common.ValueListType',
        CollectionPath: 'SupplierProductNumberVH',
        SearchSupported,
        Parameters    : [
            {
                $Type            : 'Common.ValueListParameterInOut',
                LocalDataProperty: supplierProductNumber,
                ValueListProperty: 'supplierProductNumber',
            },
            {
                $Type            : 'Common.ValueListParameterIn',
                LocalDataProperty: supplier_ID,
...
annotate service.ProductSizes with {
    ...
    evaluationColor              @(
        Common.ValueList: {
            $Type         : 'Common.ValueListType',
            CollectionPath: 'EvaluationColorsVH',
            SearchSupported,
            Parameters    : [
                {
                    $Type            : 'Common.ValueListParameterInOut',
                    LocalDataProperty: evaluationColor_ID,
                    ValueListProperty: 'evaluationColorID',
                },
                {
                    $Type            : 'Common.ValueListParameterIn',
                    LocalDataProperty: supplier_ID,
...
annotate service.EvaluationColorsVH with {
    evaluationColorID @title: 'Auswertefarbe'
};


// annotate service.ProductSizestatusSummary with @(UI: {Chart: {
...
// annotate service.ProductSizestatusSummary with @(
