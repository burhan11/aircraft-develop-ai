...
annotate service.ProductSizesTable with @(UI.LineItem: [
    {
        $Type: 'UI.DataField',
        Value: size_1_CODE,
...
//List report values
annotate service.ProductSizesTable with {
    evaluationColor              @(
        Common.ValueList: {
...
annotate service.ProductSizesTable with {
    // size_1                      @UI.Hidden;
    size_1Description            @(Common.ValueList: {
        $Type         : 'Common.ValueListType',
        CollectionPath: 'Sizes',
        SearchSupported,
        Parameters    : [{
            $Type            : 'Common.ValueListParameterOut',
            LocalDataProperty: size_1Description,
            ValueListProperty: 'DESCRIPTION',
        }],
    }, );
    ...
    // size_2                       @UI.Hidden;
    size_2Description            @(Common.ValueList: {
        $Type         : 'Common.ValueListType',
        CollectionPath: 'Sizes',
        SearchSupported,
        Parameters    : [{
            $Type            : 'Common.ValueListParameterOut',
            LocalDataProperty: size_2Description,
            ValueListProperty: 'DESCRIPTION',
        }],
    }, );
